...
const activities = [
  {
    id: 1,
    title: "En Intérieur",
    description: "Découvrez nos activités intérieures pour tous les goûts",
    image: "/interier.png"
  },
  {
    id: 2,
    title: "En extérieur", 
    description: "Profitez de la nature avec nos activités en plein air",
    image: "/exterier.jpg"
  }
];
            ...
            <div key={activity.id} className="group">
              <div className="relative aspect-[4/5] rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="absolute inset-0 flex items-center justify-center p-6 md:p-8">
                  <div className="bg-[#D4AF37]/80 rounded-2xl p-6 md:p-8">
