...
export default function FamillePage() {
  ...
  const breadcrumbItems = [
    { label: t.famillePage.breadcrumbHome, path: "/" },
    { label: t.famillePage.breadcrumbExperiences, path: "/experiences" },
    { label: t.famillePage.breadcrumbFamily, path: null }
  ];

  const familyFeatures = t.famillePage.features;
  const familyMoments = t.famillePage.moments;
  
  const localActivities = t.famillePage.activities;
    ...
    <div className="min-h-screen bg-[#F5F0E6] overflow-hidden">
      ...
      <div className="w-full px-4 py-20">
        <div className="max-w-[1120px] mx-auto">
          <h2 className="text-center text-[#231F20] text-4xl font-semibold font-['Playfair_Display'] leading-[60px] mb-16">
            {t.famillePage.sections.whyFamilies}
          </h2>
      ...
      <div className="w-full px-80 py-20 bg-white">
        <div className="max-w-[1280px] mx-auto">
          <h2 className="text-center text-[#231F20] text-4xl font-semibold font-['Playfair_Display'] leading-[60px] mb-16">
            {t.famillePage.sections.momentsToShare}
          </h2>
          ...
          <div className="text-center mt-6">
            <div className="flex justify-center items-center gap-2">
              ...
              <p className="text-[#374151] text-base font-normal font-['Cormorant']">
                {t.famillePage.sections.moreActivities}
              </p>
            </div>
          </div>
        </div>
