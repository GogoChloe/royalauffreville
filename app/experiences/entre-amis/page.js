...
export default function EntreAmisPage() {
  ...
  const breadcrumbItems = [
    { label: t.entreAmisPage.breadcrumbHome, path: "/" },
    { label: t.entreAmisPage.breadcrumbExperiences, path: "/experiences" },
    { label: t.entreAmisPage.breadcrumbFriends, path: null }
  ];

  const friendsFeatures = t.entreAmisPage.features;
  const friendsMoments = t.entreAmisPage.moments;
  const localActivities = t.entreAmisPage.activities;
    ...
    <div className="min-h-screen bg-[#F5F0E6] overflow-hidden">
      ...
      <div className="relative w-full h-[859px] mt-8">
        <img 
          ...
          src="/amis.JPG" 
          alt="Entre Amis Royal Auffreville"
        />
      ...
      <div className="w-full px-80 py-20 bg-white">
        <div className="max-w-[1280px] mx-auto">
          <h2 className="text-center text-[#231F20] text-4xl font-semibold font-['Playfair_Display'] leading-[60px] mb-16">
            {t.entreAmisPage.sections.momentsToShare}
          </h2>
          
          <div className="flex justify-center gap-8">
            {friendsMoments.map((moment, index) => (
          ...
          <div className="text-center mt-6">
            <div className="flex justify-center items-center gap-2">
              ...
              <p className="text-[#374151] text-base font-normal font-['Cormorant']">
                {t.entreAmisPage.sections.moreActivities}
              </p>
            </div>
          </div>
        </div>
