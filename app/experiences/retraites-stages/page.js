...
export default function RetraitesStagesPage() {
  const router = useRouter();
  const { language, t } = useLanguage();

  const breadcrumbItems = [
    { label: t.retraitesStagesPage.breadcrumbHome, path: "/" },
    { label: t.retraitesStagesPage.breadcrumbExperiences, path: "/experiences" },
    { label: t.retraitesStagesPage.breadcrumbRetreats, path: null }
  ];

  const retreatFeatures = t.retraitesStagesPage.features;
  const retreatMoments = t.retraitesStagesPage.moments;
  const localActivities = t.retraitesStagesPage.activities;
    ...
    <div className="min-h-screen bg-[#F5F0E6] overflow-hidden">
      ...
      <div className="relative w-full h-[859px] mt-8">
        <img 
          ...
          src="/stage.png" 
          alt="Retraites & Stages Royal Auffreville"
        />
      ...
      <div className="w-full px-80 py-20 bg-white">
        <div className="max-w-[1280px] mx-auto">
          <h2 className="text-center text-[#231F20] text-4xl font-semibold font-['Playfair_Display'] leading-[60px] mb-16">
            {t.retraitesStagesPage.sections.momentsToShare}
          </h2>
          
          <div className="flex justify-center gap-8">
            {retreatMoments.map((moment, index) => (
        ...
        <div className="max-w-[1425px] mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-[#374151] text-4xl font-semibold font-['Playfair_Display'] leading-[60px] mb-3">
              {t.retraitesStagesPage.sections.localActivities}
            </h2>
            <p className="text-[#374151] text-lg font-normal font-['Cormorant'] leading-loose max-w-[672px] mx-auto">
              {t.retraitesStagesPage.sections.localActivitiesSubtitle}
            </p>
          </div>
          ...
          <div className="text-center mt-6">
            <div className="flex justify-center items-center gap-2">
              ...
              <p className="text-[#374151] text-base font-normal font-['Cormorant']">
                {t.retraitesStagesPage.sections.moreActivities}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="w-full py-24 flex flex-col items-center gap-16">
        <h2 className="text-center text-[#8B5E3C] text-4xl font-semibold font-['Playfair_Display'] leading-[52px] max-w-4xl">
          {t.retraitesStagesPage.cta.title}
        </h2>
        ...
        >
          {t.retraitesStagesPage.cta.button2}
        </button>
      </div>
